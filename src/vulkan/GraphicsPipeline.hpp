...
struct PipelineConfig {
    ...
    bool depthBiasEnable = false;           // true for shadow passes — set values via cmd.setDepthBias()
...
public:
    ...
    [[nodiscard]] vk::Pipeline getDirShadowPipeline()    const { return dirShadowPipeline_; }
    ...
    [[nodiscard]] vk::PipelineLayout getDirShadowPipelineLayout() const { return dirShadowPipelineLayout_; }
private:
    ...
    vk::PipelineLayout dirShadowPipelineLayout_;
    ...
    vk::Pipeline dirShadowPipeline_;
    ...
    void createDirShadowPipelineLayout();
